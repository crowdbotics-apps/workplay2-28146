"""workplay2_28146 URL Configuration
...
admin.site.site_header = "WorkPlay2"
admin.site.site_title = "WorkPlay2 Admin Portal"
admin.site.index_title = "WorkPlay2 Admin"

# swagger
api_info = openapi.Info(
    title="WorkPlay2 API",
    default_version="v1",
    description="API documentation for WorkPlay2 App",
)
